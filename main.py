...
def end_screen(win, elapsed_time, targets_pressed, clicks):
    ...
    win.blit(hits_label, (get_medium(hits_label), 300))
    win.blit(accuracy_label, (get_medium(accuracy_label), 400))
...
def main():
    ...
    while run:
        ...
        if misses >= LIVES:
            end_screen(WIN, elapsed_time, targets_pressed, clicks)  # 退出游戏
